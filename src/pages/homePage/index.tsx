import { Navigation, CountdownTimer } from "../../components";
    ...
    <section className="w-screen h-screen flex flex-col relative overflow-hidden ">
      ...
      <div className="flex-grow px-24 flex flex-col items-center mlg:px-14 mxs:px-10">
        <div className="mb-6 mlg:mt-6 mmd:mt-8 msm:mt-10 mxs:mt-12">
          <p className="font-playwrite text-4xl mxxss:text-2xl">Ifeoma & Tochi</p>
        </div>
        <div className="flex justify-center items-center gap-6">
          <p className="mxxss:text-sm mxxxs:text-xs mxs:text-center">OCTOBER 26, 2024</p>
        ...
        <div className="w-full h-full">
          <img src={MainImage} alt="Pastors' Image" className="max-h-[35%] w-full object-cover rounded-3xl mlg:max-h-[45%] msm:max-h-[55%] mxs:max-h-[80%] mxxxs:max-h-[100%]:" style={{objectPosition: "0% 30%"}}/>
        </div>
      </div>
