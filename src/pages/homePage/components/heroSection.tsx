    ...
    <section className="w-screen h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="flex-grow px-24 flex flex-col items-center mlg:px-14 mxs:px-10">
        ...
        <div className="w-full h-full">
          <img src={MainImage} alt="Pastors' Image" className="max-h-[33%] w-full object-cover rounded-3xl mlg:max-h-[45%] msm:max-h-[55%] mxs:max-h-[80%] mxxxs:max-h-[100%]:" style={{objectPosition: "0% 30%"}}/>
        </div>
      </div>
