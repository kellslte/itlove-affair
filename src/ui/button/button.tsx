...
const Button: React.FC<BtnProps> = ({ text, ...props }) => {
  return (
    <button className="relative overflow-hidden cursor-pointer text-[#E0B807] bg-transparent flex justify-center items-center py-[0.75rem] px-5 border-2 border-[#E0B807] rounded-[2.5rem] group hover:text-white mxxss:px-3" {...props}>
